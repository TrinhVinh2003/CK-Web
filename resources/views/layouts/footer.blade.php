            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="widget widget-about">
                        ...
                        <img src={{ asset('images/branding/logos/VinhCinemat.png') }} alt="logo" class="logo">
                        <!-- INSERT YOUR WHITE LOGO HERE -->
                        <img src={{ asset('images/branding/logos/VinhCinemat-w.png') }} alt="white logo" class="logo-white">
