    ...
    <div class="container-fluid">
        ...
        <nav class="navbar navbar-expand-lg">
            ...
            <a class="navbar-brand" href="{{ route('home') }}">
                ...
                <img src="{{ asset('images/branding/logos/VinhCinemat.png') }}" alt="logo" width="200" class="logo">
                <!-- INSERT YOUR WHITE LOGO HERE -->
                <img src="{{ asset('images/branding/logos/VinhCinemat-w.png') }}" alt="white logo" width="200"
                    class="logo-white">
            </a>
